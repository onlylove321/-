...
public class SimpleMailSender extends BaseController {
	...
	public boolean sendMail(String title, String content, String type, String tomail) throws Exception {
		...
		mailInfo.setUserName("15382007662@163.com");
		mailInfo.setPassword("DHL15382007662");// 您的邮箱密码
		mailInfo.setFromAddress("15382007662@163.com");
	...
	public static void main(String[] args) throws Exception {
		...
		mailInfo.setPassword("DHL15382007662");// 您的邮箱密码
		mailInfo.setFromAddress("15382007662@163.com");
		mailInfo.setToAddress("1078852959@qq.com");
